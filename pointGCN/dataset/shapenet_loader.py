...
class ShapeNet(InMemoryDataset):
    ...
    **STATS:**
    ...
    url = 'https://drive.google.com/u/0/uc?id=1YCkjkialQRP0lA816AE7vUUpu-W7TAT5&export=download&confirm=t&uuid=c2b70541-f27b-4a6f-ac25-519f4fc12f88&at=ALt4Tm3mRhug74g7zvfGlGAzSBtw:1691498161787' 
    #'https://drive.google.com/u/0/uc?id=1JsmKOAKVieP2fKjDqHbvEZF0jCfaAtbJ&export=download&confirm=t&uuid=f0f62fe4-744c-4bd6-bbae-0baec978fd97&at=ALt4Tm1IGGT5IIyJaTuWpHF6AvT4:1691497487455'
    ...
    #'https://drive.google.com/file/d/1YCkjkialQRP0lA816AE7vUUpu-W7TAT5/view?usp=sharing'
    ...
    def download(self):
        ...
        name =  'shapenetcore_partanno_segmentation_benchmark_v0_normal' # self.url.split('/')[-1].split('.')[0]
